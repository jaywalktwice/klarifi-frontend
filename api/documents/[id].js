  ...
  doc_002: {
    ...
    extraction: {
      ...
      fields: [
        ...
        { field_name: 'importer_name', field_value: 'Klerifi Technologies (Pty) Ltd', field_type: 'text', confidence: 0.96 },
  ...
  doc_003: {
    ...
    extraction: {
      ...
      fields: [
        ...
        { field_name: 'account_holder', field_value: 'Klerifi Technologies (Pty) Ltd', field_type: 'text', confidence: 0.98 },

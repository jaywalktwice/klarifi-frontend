  ...
  return (
    <div className="landing-wrapper">
      ...
      <section className="diff">
        <div className="ctn">
          <div className="sl rv">What makes Klarifi different</div>
          <h2 className="st rv">This isn't another invoice scanner</h2>
          <p className="ss rv">Tools like Sage AutoEntry only handle invoices and receipts for accounting software. Klarifi reads any document and outputs to any system.</p>
          <div className="db rv">
            <div className="dl">
            ...
            <div className="drt">
              ...
              <div className="dtc rv"><div className="dti">📄</div><div><h4>Any Other Document</h4><p>If a human can read it, Klarifi can extract it</p></div></div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="ind" id="industries">
        <div className="ctn">
          ...
          <p className="ss rv">Every industry has its document nightmare. Klarifi speaks your language.</p>
          <div className="ig">
      ...
      <section className="how" id="how">
        <div className="ctn">
          ...
          <div className="steps">
            <div className="step rv"><div className="sn">1</div><h3>Upload any document</h3><p>PDF, scan, photo — any format, any quality, any language. Drop it in and Klarifi handles the rest.</p><div className="sa">→</div></div>
      ...
      <section className="nw">
        <div className="ctn">
          ...
          <p className="ss rv">Klarifi doesn't replace your software. It feeds it. Here's what the workflow actually looks like for your industry.</p>

...
export default function Landing() {
  ...
  useEffect(() => {
    ...
    if ('IntersectionObserver' in window) {
      ...
      }, { threshold: 0.04, rootMargin: '60px' });
      els.forEach(e => o.observe(e));
    }
    
    const timeout = setTimeout(() => {
      els.forEach(e => {
        if (!e.classList.contains('v')) e.classList.add('v');
      });
    }, 1500);
    ...
    <div className="landing-wrapper">
      ...
      <section className="prob rv">
        <div className="ctn">
          ...
          <h2 className="st">Namibian businesses are drowning in paperwork</h2>
          <p className="ss">Every document that enters your office starts the same way: someone reads it, types the data into a system, and hopes they don't make a mistake.</p>
          <div className="pg">
            <div className="pc">
      ...
      <section className="diff rv">
        <div className="ctn">
          <div className="sl">What makes Klarifi different</div>
          <h2 className="st">This isn't another invoice scanner</h2>
          <p className="ss">Tools like Sage AutoEntry only handle invoices and receipts for accounting software. Klarifi reads any document and outputs to any system.</p>
          <div className="db">
            <div className="dl">
              <h3>Accounting add-ons scan invoices.<br />Klarifi reads <em style={{ color: 'var(--accent-l)', fontFamily: 'var(--fd)' }}>everything.</em></h3>
              ...
              <p>Klarifi uses general-purpose AI that understands any document type, in any format, in any language — including the ones no off-the-shelf tool was built for.</p>
              <div className="dc">
                ...
                <div className="dr us"><span className="ck">✓</span> Klarifi: Any document, any format, any language</div>
            ...
            <div className="drt">
              <div style={{ fontSize: '0.72rem', textTransform: 'uppercase', letterSpacing: '1.2px', color: 'var(--t3)', fontWeight: '600', marginBottom: '0.25rem' }}>Documents Klarifi reads</div>
              <div className="dtc"><div className="dti">🚢</div><div><h4>Customs Declarations & SAD Forms</h4><p>HS codes, CIF values, consignee, origin — ready for ASYCUDA</p></div></div>
              <div className="dtc"><div className="dti">📋</div><div><h4>Bills of Lading & Packing Lists</h4><p>Vessel, container, weight, descriptions, port details</p></div></div>
              <div className="dtc"><div className="dti">📑</div><div><h4>Contracts & Legal Documents</h4><p>Parties, dates, key clauses, obligations, termination terms</p></div></div>
              <div className="dtc"><div className="dti">🧾</div><div><h4>Invoices, Receipts & Statements</h4><p>Vendor, amounts, line items, VAT — export to Sage, Pastel, any CSV</p></div></div>
              <div className="dtc"><div className="dti">🏛️</div><div><h4>Government Forms & Applications</h4><p>Citizen data, permit details, ID documents, tax forms</p></div></div>
              <div className="dtc"><div className="dti">📄</div><div><h4>Any Other Document</h4><p>If a human can read it, Klarifi can extract it</p></div></div>
            </div>
          </div>
        </div>
      </section>

      <section className="demo rv">
        <div className="ctn">
          <div className="dw">
      ...
      <section className="ind rv" id="industries">
        <div className="ctn">
          <div className="sl">Who it's for</div>
          <h2 className="st">Built for businesses that run on paper</h2>
          <p className="ss">Every industry has its document nightmare. Klarifi speaks your language.</p>
          <div className="ig">
            <div className="ic"><div className="ii">🚢</div><h3>Customs & Freight</h3><p>Extract data from shipping docs and paste straight into ASYCUDA. Clear shipments faster, avoid demurrage charges.</p><div className="iu">→ Bills of Lading, SAD Forms, Packing Lists</div></div>
            <div className="ic"><div className="ii">📊</div><h3>Accounting & Tax</h3><p>Process invoices, receipts, and bank statements. Export CSV into Sage, Pastel, or QuickBooks. Prepare NamRA submissions faster.</p><div className="iu">→ Invoices, Receipts, Bank Statements</div></div>
            <div className="ic"><div className="ii">⚖️</div><h3>Legal & Compliance</h3><p>Extract key clauses, parties, dates, and obligations from contracts. Complete due diligence in days, not weeks.</p><div className="iu">→ Contracts, Court Filings, Deeds</div></div>
            <div className="ic"><div className="ii">🏛️</div><h3>Government</h3><p>Digitize citizen applications, permits, and ID documents. Reduce backlogs and improve service delivery for all Namibians.</p><div className="iu">→ Applications, Permits, Tax Forms</div></div>
          </div>
        </div>
      </section>
      ...
      <section className="how rv" id="how">
        <div className="ctn">
          ...
          <h2 className="st">Three steps. Zero complexity.</h2>
          <p className="ss">No training needed. No setup fees. Upload a document and see results in seconds.</p>
          <div className="steps">
            <div className="step"><div className="sn">1</div><h3>Upload any document</h3><p>PDF, scan, photo — any format, any quality, any language. Drop it in and Klarifi handles the rest.</p><div className="sa">→</div></div>
            <div className="step"><div className="sn">2</div><h3>AI reads and extracts</h3><p>Our AI identifies the document type, reads every field, and returns structured data with confidence scores you can trust.</p><div className="sa">→</div></div>
            <div className="step"><div className="sn">3</div><h3>Export and use</h3><p>Download clean CSV or JSON. Import into Sage, Pastel, ASYCUDA, or any system. Review, approve, done.</p></div>
          </div>
        </div>
      </section>

      <section className="aft rv">
        <div className="ctn">
          <div className="sl">Beyond extraction</div>
          <h2 className="st">The data unlocks answers you've never had time to find</h2>
          <p className="ss">Extraction is step one. What you do with structured data is where the real value lives.</p>
          <div className="afg">
            <div className="afc"><div className="afh"><div className="afi">📈</div><h3>Spot spending patterns</h3></div><p>See which vendors you're paying most, which costs are increasing, and where money leaks — across thousands of invoices, instantly.</p><div className="afe">"We discovered we were paying 3 different vendors for the same supplies at different prices."</div></div>
            <div className="afc"><div className="afh"><div className="afi">⚠️</div><h3>Catch costly errors</h3></div><p>Duplicate invoices, mismatched amounts, wrong HS codes on customs forms. Klarifi flags inconsistencies that human eyes miss under time pressure.</p><div className="afe">A single wrong HS code can mean thousands in excess duty or clearance delays.</div></div>
      ...
      <section className="nw rv">
        <div className="ctn">
          <div className="sl">Now what?</div>
          <h2 className="st">Extracted data goes straight into the systems you already use</h2>
          <p className="ss">Klarifi doesn't replace your software. It feeds it. Here's what the workflow actually looks like for your industry.</p>
          <div className="nw-grid">
            <div className="nwc"><div className="nw-head"><div className="nw-icon">📊</div><h3>Accounting Firm → Sage / Pastel</h3></div><div className="nw-flow"><div className="nw-step"><span className="nws-n">1</span> Client drops off 200 invoices</div><div className="nw-step"><span className="nws-n">2</span> You scan and upload the batch to Klarifi</div><div className="nw-step"><span className="nws-n">3</span> Klarifi extracts vendor, date, amount, VAT, line items</div><div className="nw-step"><span className="nws-n">4</span> Download CSV pre-formatted for Sage Pastel</div><div className="nw-step"><span className="nws-n">5</span> Sage → Process → Suppliers → Batch Import → Done</div></div><div className="nw-result">3 days of typing → 10 minutes. Serve 3x more clients with the same staff.</div></div>
            <div className="nwc"><div className="nw-head"><div className="nw-icon">🚢</div><h3>Customs Broker → ASYCUDA</h3></div><div className="nw-flow"><div className="nw-step"><span className="nws-n">1</span> Shipment arrives with bill of lading + customs docs</div><div className="nw-step"><span className="nws-n">2</span> Upload shipping documents to Klarifi</div><div className="nw-step"><span className="nws-n">3</span> Klarifi extracts HS codes, CIF values, consignee, origin</div><div className="nw-step"><span className="nws-n">4</span> Copy pre-validated values into ASYCUDA fields</div><div className="nw-step"><span className="nws-n">5</span> Submit declaration. Shipment cleared.</div></div><div className="nw-result">Fewer HS code errors. Faster clearance. NAD 2,000-5,000/day saved in demurrage.</div></div>
            <div className="nwc"><div className="nw-head"><div className="nw-icon">⚖️</div><h3>Law Firm → Due Diligence</h3></div><div className="nw-flow"><div className="nw-step"><span className="nws-n">1</span> Upload 50+ contracts for a property transaction</div><div className="nw-step"><span className="nws-n">2</span> Klarifi extracts parties, dates, clauses, obligations</div><div className="nw-step"><span className="nws-n">3</span> Download summary spreadsheet of all contracts</div><div className="nw-step"><span className="nws-n">4</span> Sort by termination date, filter liability clauses</div><div className="nw-step"><span className="nws-n">5</span> Lawyer reviews summary, not 50 full documents</div></div><div className="nw-result">Due diligence in days, not weeks. Billable hours shift to high-value analysis.</div></div>
            <div className="nwc"><div className="nw-head"><div className="nw-icon">🏛️</div><h3>Government → Service Delivery</h3></div><div className="nw-flow"><div className="nw-step"><span className="nws-n">1</span> Citizen submits paper application for a permit</div><div className="nw-step"><span className="nws-n">2</span> Front desk scans and uploads to Klarifi</div><div className="nw-step"><span className="nws-n">3</span> Klarifi extracts citizen data, ID, application details</div><div className="nw-step"><span className="nws-n">4</span> Data populates the internal case management system</div><div className="nw-step"><span className="nws-n">5</span> Clerk reviews and approves — no typing needed</div></div><div className="nw-result">Backlogs reduced. Faster processing. Searchable digital archive replaces filing cabinets.</div></div>
          </div>
        </div>
      </section>

      <section className="sec rv" id="security">
        <div className="ctn">
          <div className="sl">Security & data privacy</div>
          <h2 className="st">Your data stays yours. Always.</h2>
          <p className="ss">Built with a data sovereignty model designed for Southern African businesses. No compromises.</p>
          <div className="sct">
            <div className="scc"><div className="si">🔐</div><h3>AES-256 Encryption</h3><p>All stored data encrypted at rest using the same standard as banks and military systems. Unreadable even with physical access.</p></div>
            <div className="scc"><div className="si">🛡️</div><h3>TLS 1.3 In Transit</h3><p>Every connection encrypted with the latest transport security. Documents protected from upload to download.</p></div>
            <div className="scc"><div className="si">🌍</div><h3>Hosted in SACU</h3><p>All infrastructure runs on dedicated servers in Cape Town, South Africa. Your data never leaves Southern Africa.</p></div>
            <div className="scc"><div className="si">🗑️</div><h3>Auto-Deletion</h3><p>Originals permanently deleted after extraction by default. We keep only extracted text. You choose: immediate, 7, 30, or 90 days.</p></div>
          </div>
          <div className="sf">
            <h3>How your document flows through Klarifi</h3>
            <div className="fr">
      ...
      <section className="met rv">
        <div className="ctn">
          <div className="mg">
            <div className="mc"><div className="mv">3-8s</div><div className="ml">Per document</div></div>
            <div className="mc"><div className="mv">95%+</div><div className="ml">Extraction accuracy</div></div>
            <div className="mc"><div class="mv">$0</div><div className="ml">Setup cost</div></div>
            <div className="mc"><div className="mv">SACU</div><div className="ml">Data sovereignty</div></div>
          </div>
        </div>
      </section>
      ...
      <footer className="landing-footer">
        <div className="fi">
          <div className="fl">© 2026 Klarifi · Built in Windhoek, Namibia</div>

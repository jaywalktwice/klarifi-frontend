  ...
  useEffect(() => {
    ...
    class Particle {
      ...
      update(loadFadeFactor, elapsed) {
        ...
        // Ultra-slow, mature fluid motion
        const waveX = Math.sin(this.baseX * 0.002 + elapsed * 0.0003) * 20 * this.z;
        const waveY = Math.cos(this.baseY * 0.002 + elapsed * 0.0003) * 20 * this.z;
        ...
        // Barely noticeable, extremely calm wave of light
        const waveAlpha = (Math.sin(this.baseX * 0.004 + this.baseY * 0.004 - elapsed * 0.0005) * 0.5 + 0.5) * 0.08;
